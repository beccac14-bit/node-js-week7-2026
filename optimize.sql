...
CREATE INDEX IF NOT EXISTS idx_course_bookings_course_id_cancelled on course_bookings(course_id, cancelled_at);

-- 修正後
    -- 因應工單 4 調整，新增以 start_at 排序的索引
CREATE INDEX IF NOT EXISTS idx_course_bookings_startat on course_bookings(start_at);
